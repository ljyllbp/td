...
class segment_video_upload(upload):    
    ...
    def check_video_root(self, segment_root):
        ...
        video_root = self.path_join(segment_root, "source")
    ...
    # 对比视频,预标注结果
    def compare_videos_pre_labels(self, video_files_info, pre_label_files_info, segment_root):
    ...
    def check_segment_roots(self, segment_roots):
        ...
        for index, segment_root in enumerate(segment_roots):
            ...
            self.compare_videos_pre_labels(video_files_info, pre_label_files_info, segment_root)
